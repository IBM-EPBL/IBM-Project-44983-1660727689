...
training_set = train_datagen.flow_from_directory(r'Dataset\train', # relative path from working directoy
                                                 target_size = (128, 128),
                                                 batch_size = 6, class_mode = 'categorical')
valid_set = test_datagen.flow_from_directory(r'Dataset\val', # relative path from working directoy
                                             target_size = (128, 128), 
...
img = cv2.imread('C:/Users/UCS/AppData/Local/Programs/Python/Python38/Leaf_disease/data/d (7)_iaip.jpg')
